---
title: "Conflict Change Shapefiles"
...
conf_10perc <- proj_conf

conf_10perc[conf_10perc > 0.1] <- 1
conf_10perc[conf_10perc < 0.1] <- NA 

poly_per10 <- as.polygons(conf_10perc, dissolve = TRUE)


#50 percent

conf_50perc <- proj_conf

conf_50perc[conf_50perc > 0.5] <- 1
conf_50perc[conf_50perc < 0.5] <- NA 

poly_per50 <- as.polygons(conf_50perc, dissolve = TRUE)
...
#Filter current day for only 0 values and projected for nonzero values
