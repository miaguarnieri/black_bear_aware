...
```{r}
#read in the data
climate_model_data_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_data_allyears_wui.csv"))
```
...
save(climate_model_allyears_wui, file = here(gdrive_data, "/AnalysisData/model_wui_robustness/1_9_2023/climate_model_allyears_wui.rds"))
