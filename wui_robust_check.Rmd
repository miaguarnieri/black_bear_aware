...
```{r}
#load in and wrangle WUI data 
wui_2022 <- vect(here(gdrive_data, "/InputData/InputData_Files/Forest_Service_WUI_2022/CONUS_WUI_block_1990_2020_change.shp"))

wui_2022_calbers <- project(wui_2022, ca_raster)

#ca_vector <- as.polygons(ca_raster)

#wui_2022_mask <- crop(wui_2022_calbers, ca_vector)

wui_2022_raster <- rasterize(wui_2022_calbers, ca_raster)

wui_2022_ca <- mask(wui_2022_raster, ca_raster)

```

```{r}
wui_2022_claire <- vect(here(gdrive_data, "/IntermediateData/IntermediateData_Files/wui_claire/wui_union.shp"))
wui_2022_calbers <- project(wui_2022_claire, ca_raster)
wui_2022_raster <- rasterize(wui_2022_calbers, ca_raster)
wui_2022_ca <- mask(wui_2022_raster, ca_raster)
...
conbuff16_inverse <- mask(wui_2022_ca, conbuff16_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_16.csv"), row.names = FALSE)
...
#create an inverse mask- Anything withing the conflict buffer shapefiles will be a 0 value. So we get a California raster with all the conflict buffer locations zeroed out
conbuff17_inverse <- mask(wui_2022_ca, conbuff17_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_17.csv"), row.names = FALSE)
...
conbuff18_inverse <- mask(wui_2022_ca, conbuff18_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_18.csv"), row.names = FALSE)
```
...
conbuff19_inverse <- mask(wui_2022_ca, conbuff19_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_19.csv"), row.names = FALSE)
...
conbuff20_inverse <- mask(wui_2022_ca, conbuff20_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_20.csv"), row.names = FALSE)
...
conbuff21_inverse <- mask(wui_2022_ca, conbuff21_reproj, inverse = TRUE)
...
write.csv(clim_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_21.csv"), row.names = FALSE)
...
climdf16_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_16.csv"))

climdf17_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_17.csv"))

climdf18_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_18.csv"))

climdf19_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_19.csv"))

climdf20_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_20.csv"))

climdf21_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_wui_21.csv"))

climate_model_data_allyears_wui <- rbind(climdf16_wui, climdf17_wui, climdf18_wui, climdf19_wui, climdf20_wui, climdf21_wui)

#test that all your years are present

unique(climate_model_data_allyears_wui$year)

#relevel the factors

relevel(as.factor(climate_model_data_allyears_wui$lc), ref = "barren_land")
...
write.csv(climate_model_data_allyears_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_data_allyears_wui.csv"), row.names = FALSE)
...
```{r}
#read in the data
climate_model_data_wui <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_df_robustness/1_9_2023/climate_model_data_allyears_wui.csv"))
```

```{r}
#run the rspf

climate_model_allyears_wui <- rspf(conflict ~ dem + aspect + TRI + popdens + lc + road_dens + road_dist + streams_dist + urban_dist + rec_dist + forest_dist + forest_dens + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)

#save the model 
save(climate_model_allyears_wui, file = here("models", "climate_model_data_allyears_wui.rds"))


save(climate_model_allyears_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/climate_model_allyears_wui.rds"))
...
mod1_wui <- rspf(conflict ~ dem + lc + forest_dist + popdens + rec_dist + road_dens + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)
...
mod2_wui <- rspf(conflict ~ dem + forest_dens + lc + forest_dist + popdens + rec_dist + road_dens + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)
...
mod3_wui <- rspf(conflict ~ dem + lc + forest_dist + popdens + rec_dist + streams_dist + TRI + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)
...
mod4_wui <- rspf(conflict ~ dem + forest_dens + lc + forest_dist + popdens + rec_dist + streams_dist + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)
...
mod5_wui <- rspf(conflict ~ dem + lc + forest_dist + popdens + streams_dist + TRI + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data_wui)

```
#save the models
```{r}
save(mod1_wui, file = here("models", "mod1_wui.rds"))
save(mod1_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/mod1_wui.rds"))

save(mod2_wui, file = here("models", "mod2_wui.rds"))
save(mod2_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/mod2_wui.rds"))

save(mod3_wui, file = here("models", "mod3_wui.rds"))
save(mod3_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/mod3_wui.rds"))

save(mod4_wui, file = here("models", "mod4_wui.rds"))
save(mod4_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/mod4_wui.rds"))

save(mod5_wui, file = here("models", "mod5_wui.rds"))
save(mod5_wui, file = here(gdrive_data, "/AnalysisData/robustness_check_data/model_wui_robustness/1_9_2023/mod5_wui.rds"))
...
```
```{r}
AIC(climate_model_allyears_wui)
```
