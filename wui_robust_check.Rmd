...
```{r}
wui_2022_claire <- vect(here(gdrive_data, "/IntermediateData/IntermediateData_Files/wui_claire/wui_claire.shp"))
...
```{r}
tm_shape(wui_2022_raster) +
  tm_raster() +
  tmap_mode("view")

plot(wui_2022_calbers)
```
...
#write the raster into the correct folder in drive (the path will need to be updated for other files) and save it as a shapefile
  ...
  writeVector(x, filename = here(gdrive_data, "/IntermediateData/IntermediateData_Files/ca_wui_shp", name), filetype = "ESRI Shapefile", overwrite=TRUE)
}

#save the file
savevect(wui_2022_mask)
```
...
write.csv(clim_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_16.csv"), row.names = FALSE)
...
tm_shape(conbuff17_inverse_wui) +
  tm_raster() +
  tmap_mode("view")
...
write.csv(clim_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_17.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_18.csv"), row.names = FALSE)
```
...
write.csv(clim_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_19.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_20.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_21.csv"), row.names = FALSE)
...
climdf16_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_16.csv"))

climdf17_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_17.csv"))

climdf18_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_18.csv"))

climdf19_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_19.csv"))

climdf20_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_20.csv"))

climdf21_wui <- read_csv(here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_wui_21.csv"))

climate_model_data_allyears_wui <- rbind(climdf16_wui, climdf17_wui, climdf1_wui, climdf19_wui, climdf20_wui, climdf21_wui)
...
write.csv(climate_model_data_allyears_wui, file = here(gdrive_data, "/AnalysisData/model_wui_df_robustness/1_9_2023/climate_model_data_allyears_wui.csv"), row.names = FALSE)
