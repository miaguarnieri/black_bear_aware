...
#create distance layers using urban area raster layers

ua_dist_01 <- distance(ua01)

ua_dist_04 <- distance(ua04)

ua_dist_06 <- distance(ua06)

ua_dist_08 <- distance(ua08)

ua_dist_11 <- distance(ua11)

ua_dist_13 <- distance(ua13)

ua_dist_16 <- distance(ua16)

ua_dist_19 <- distance(ua19)
```

##Save reclassified, reprojected, and clipped urban distance rasters to the data drive
...
#write the raster into the correct folder in drive (the path will need to be updated for other files) and save it as a geotiff
  ...
  writeRaster(x, filename = here(gdrive_data, "/IntermediateData/IntermediateData_Files/distance_rasters/dist_to_urban", name), filetype = "GTiff")
}
...
##Save reclassified, reprojected, and clipped forest distance rasters to the data drive
...
#write the raster into the correct folder in drive (the path will need to be updated for other files) and save it as a geotiff
  ...
  writeRaster(x, filename = here(gdrive_data, "/IntermediateData/IntermediateData_Files/distance_rasters/dist_to_forest", name), filetype = "GTiff")
}
