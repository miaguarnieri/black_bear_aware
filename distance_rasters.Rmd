...
saverast(rec_areas_pb_raster)
saverast(rec_areas_rr_raster)
saverast(rec_areas_buildings_raster)
saverast(rec_areas_structures_raster)
saverast(rec_areas_parking_raster)
saverast(rec_areas_PEP_raster)
saverast(rec_areas_picnic_raster)
saverast(rec_areas_camp_raster)
```
