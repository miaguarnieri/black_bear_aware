---
title: "climate_model _hist_fire"
...
#fire
dist_fire05_06 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire05_06_ca_distance.tif"))

dist_fire06_07 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire06_07_ca_distance.tif"))

dist_fire07_08 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire07_08_ca_distance.tif"))

dist_fire08_09 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire08_09_ca_distance.tif"))

dist_fire09_10 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire09_10_ca_distance.tif"))

dist_fire10_11 <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/dist_fire/fire10_11_ca_distance.tif"))
...
climstack16 <- c(dem, aspect, ter_rug, pop16, lc16, road_dens, road_dist, streams_dist, urban_dist_16, rec_dist, fc_dist_16, fdens, dist_fire15, dist_fire13_14, dist_fire11_12, dist_fire09_10, dist_fire07_08, dist_fire05_06, drought_2016)
...
colnames(clim_zero_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_16.csv"), row.names = FALSE)
...
climstack17 <- c(dem, aspect, ter_rug, pop17, lc16, road_dens, road_dist, streams_dist, urban_dist_16,rec_dist,fc_dist_16, fdens, dist_fire16, dist_fire14_15, dist_fire12_13, dist_fire10_11, dist_fire08_09, dist_fire06_07, drought_2017)
...
colnames(clim_zero_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_17.csv"), row.names = FALSE)
...
climstack18 <- c(dem, aspect, ter_rug, pop18, lc16, road_dens, road_dist, streams_dist, urban_dist_16, rec_dist, fc_dist_16, fdens, dist_fire17, dist_fire15_16, dist_fire13_14, dist_fire11_12, dist_fire09_10, dist_fire07_08, drought_2018)
...
colnames(clim_zero_vars18) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars18) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_18.csv"), row.names = FALSE)
```
...
climstack19 <- c(dem, aspect, ter_rug, pop19, lc19, road_dens, road_dist, streams_dist, urban_dist_19, rec_dist, fc_dist_19, fdens, dist_fire18, dist_fire16_17, dist_fire14_15, dist_fire12_13, dist_fire10_11, dist_fire08_09, drought_2019)
...
colnames(clim_zero_vars19) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars19) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_19.csv"), row.names = FALSE)
...
climstack20 <- c(dem, aspect, ter_rug, pop20, lc19, road_dens, road_dist, streams_dist, urban_dist_19, rec_dist, fc_dist_19, fdens, dist_fire19, dist_fire17_18, dist_fire15_16, dist_fire13_14, dist_fire11_12, dist_fire09_10, drought_2020)
...
colnames(clim_zero_vars20) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars20) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_20.csv"), row.names = FALSE)
...
climstack21 <- c(dem, aspect, ter_rug, pop21, lc19, road_dens, road_dist, streams_dist, urban_dist_19, rec_dist, fc_dist_19, fdens, dist_fire20, dist_fire18_19, dist_fire16_17,  dist_fire14_15, dist_fire12_13, dist_fire10_11, drought_2021)
...
colnames(clim_zero_vars21) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")

colnames(clim_con_vars21) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","dist_fire_67yr", "dist_fire_89yr", "dist_fire_1011yr", "drought")
...
write.csv(clim_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_21.csv"), row.names = FALSE)
...
climdf16 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_16.csv"))

climdf17 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_17.csv"))

climdf18 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_18.csv"))

climdf19 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_19.csv"))

climdf20 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_20.csv"))

climdf21 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_modeldf_21.csv"))
...
write.csv(climate_model_data_allyears, file = here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_model_data_allyears.csv"), row.names = FALSE)
```
...
```{r}
#read in the data
climate_model_data <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/05_18_2023/climate_model_data_allyears.csv")) %>% 
  drop_na()
```
...
# save(climate_model_allyears, file = here(gdrive_data, "/AnalysisData/models/05_18_2023/model_allyears_climate/climate_model_allyears.rds"))
...
mod3climate_hist_fire <- rspf(conflict ~ dem + lc + forest_dist + popdens + rec_dist + streams_dist + TRI + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + dist_fire_67yr + dist_fire_89yr + dist_fire_1011yr + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data)

#saving mod 3 with climate 
save(mod3climate, file = here("models", "mod3climate_hist_fire.rds"))

#save(climate_model_allyears, file = here(gdrive_data, "/AnalysisData/models/05_18_2023/mod3_allyears_climate/mod3climate.rds"))

AIC(mod3climate_hist_fire)
...
mod3climate_sq_hist_fire <- rspf(conflict ~ dem + lc + forest_dist + I(popdens^2) + rec_dist + streams_dist + TRI + urban_dist + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + dist_fire_67yr + dist_fire_89yr + dist_fire_1011yr + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data)

#save the model 
save(mod3climate_sq_hist_fire, file = here("models", "mod3climate_hist_fire.rds"))

AIC(mod3climate_sq_hist_fire)
