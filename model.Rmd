...
=======
#Load in data layers
>>>>>>> 02f073ea33c4b10d8a189895c95352cb65d84553
...
stack16 <- c(dem, aspect, ter_rug, pop16, lc16,road_dens2, road_dist, urban_dist_16, fc_dist_16)
...
var_ex <- extract(stack16, con_16_sv, method = "simple", bind = TRUE, ID = TRUE)

var_df <- as.data.frame(var_ex)

#run it in the model

model <- rspf(ID ~ aspect + TRI + category, family = "binomial", m = 0, B = 1000, data = var_df)
