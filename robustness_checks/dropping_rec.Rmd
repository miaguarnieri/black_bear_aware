...
climstack16 <- c(dem, aspect, ter_rug, pop16, lc16, road_dens, road_dist, streams_dist, urban_dist_16, fc_dist_16, fdens, dist_fire15, dist_fire13_14, dist_fire11_12, drought_2016)
...
colnames(clim_zero_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs","drought")

colnames(clim_con_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_16 <- rbind(clim_zero_vars16, clim_con_vars16)

#label the year for later binding with other dfs

rec_modeldf_16 <- clim_model_df_16 %>% 
  mutate(year = 2016)
...
write.csv(rec_modeldf_16, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_16.csv"), row.names = FALSE)
...
climstack17 <- c(dem, aspect, ter_rug, pop17, lc16, road_dens, road_dist, streams_dist, urban_dist_16,fc_dist_16, fdens, dist_fire16, dist_fire14_15, dist_fire12_13, drought_2017)
...
colnames(clim_zero_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

colnames(clim_con_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_17 <- rbind(clim_zero_vars17, clim_con_vars17)

#label the year for later binding with other dfs
rec_modeldf_17 <- clim_model_df_17 %>% 
  mutate(year = 2017) %>% 
  as.data.frame()
...
write.csv(rec_modeldf_17, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_17.csv"), row.names = FALSE)
```
...
climstack18 <- c(dem, aspect, ter_rug, pop18, lc16, road_dens, road_dist, streams_dist, urban_dist_16, fc_dist_16, fdens, dist_fire17, dist_fire15_16, dist_fire13_14, drought_2018)
...
colnames(clim_zero_vars18) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

colnames(clim_con_vars18) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_18 <- rbind(clim_zero_vars18, clim_con_vars18)

#label the year for later binding with other dfs
rec_modeldf_18 <- clim_model_df_18 %>% 
  mutate(year = 2018) %>% 
  as.data.frame()
...
write.csv(rec_modeldf_18, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_18.csv"), row.names = FALSE)
```
...
climstack19 <- c(dem, aspect, ter_rug, pop19, lc19, road_dens, road_dist, streams_dist, urban_dist_19, fc_dist_19, fdens, dist_fire18, dist_fire16_17, dist_fire14_15, drought_2019)
...
colnames(clim_zero_vars19) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

colnames(clim_con_vars19) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_19 <- rbind(clim_zero_vars19, clim_con_vars19)

#label the year for later binding with other dfs
rec_modeldf_19 <- clim_model_df_19 %>% 
  mutate(year = 2019) %>% 
  as.data.frame()
...
write.csv(rec_modeldf_19, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_19.csv"), row.names = FALSE)
...
climstack20 <- c(dem, aspect, ter_rug, pop20, lc19, road_dens, road_dist, streams_dist, urban_dist_19, fc_dist_19, fdens, dist_fire19, dist_fire17_18, dist_fire15_16, drought_2020)
...
colnames(clim_zero_vars20) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

colnames(clim_con_vars20) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_20 <- rbind(clim_zero_vars20, clim_con_vars20)

#label the year for later binding with other dfs
rec_modeldf_20 <- clim_model_df_20 %>% 
  mutate(year = 2020) %>% 
  as.data.frame()
...
write.csv(rec_modeldf_20, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_20.csv"), row.names = FALSE)
...
climstack21 <- c(dem, aspect, ter_rug, pop21, lc19, road_dens, road_dist, streams_dist, urban_dist_19, fc_dist_19, fdens, dist_fire20, dist_fire18_19, dist_fire16_17, drought_2021)
...
colnames(clim_zero_vars21) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

colnames(clim_con_vars21) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs", "drought")

clim_model_df_21 <- rbind(clim_zero_vars21, clim_con_vars21)

#label the year for later binding with other dfs
rec_modeldf_21 <- clim_model_df_21 %>% 
  mutate(year = 2021) %>% 
  as.data.frame()
...
write.csv(rec_modeldf_21, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_21.csv"), row.names = FALSE)
```
...
climdf16 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_16.csv"))

climdf17 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_17.csv"))

climdf18 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_18.csv"))

climdf19 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_19.csv"))

climdf20 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_20.csv"))

climdf21 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_modeldf_21.csv"))

rec_model_data_allyears <- rbind(climdf16, climdf17, climdf18, climdf19, climdf20, climdf21)

#test that all your years are present

unique(rec_model_data_allyears$year)

#relevel the factors

relevel(as.factor(rec_model_data_allyears$lc), ref = "barren_land")
...
write.csv(rec_model_data_allyears, file = here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_model_data_allyears.csv"), row.names = FALSE)
```
...
```{r}
#read in the data
rec_model_data <- read_csv(here(gdrive_data, "/AnalysisData/model_df_robustness/12_19_22/rec_model_data_allyears.csv"))
```
