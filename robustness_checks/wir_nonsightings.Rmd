---
title: "Nonsighting Robustness Check"
...
#Read in and tidy up WIR data

```{r}

wir_points <- read_sf(here(gdrive_data,"/IntermediateData/IntermediateData_Files/conflict_formatted/conflict_points/conflict_points.shp"))

wir_nonsightings <- wir_points %>% 
  filter(cnfrmd_ != "Sighting")

st_write(wir_nonsightings, dsn = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/WIR_nonsightings.shp"), append = FALSE)
```

#Create new buffer file from tidied data

```{r}
#Buffer conflict points to create conflict raster

# load in conflict data 
conflict_points <- read_sf(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/WIR_nonsightings.shp"))

#reprojecting to NAD83(2011) / California Albers
conflict_points_albers <- st_transform(conflict_points, crs = 6414)
...
conflict_buffer_refined <- conflict_points_buffered %>% 
...
#saving the file to intermediate data in the gdrive
 ...
 st_write(conflict_buffer_refined, dsn = here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/conflict_buffered_refined", "wir_nonsighting_buffered_refined.shp"))
```

#Redo model with nonsighting data

#Load in data layers

```{r}
#conflict data
conflict_buffers <- read_sf(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/conflict_buffered_refined", "wir_nonsighting_buffered_refined.shp"))
...
sample16 <- st_sample(cabuff16_inv_sf, (nrow(conpoints16_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_16.csv"), row.names = FALSE)
...
sample17 <- st_sample(cabuff17_inv_sf, (nrow(conpoints17_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_17.csv"), row.names = FALSE)
...
sample18 <- st_sample(cabuff18_inv_sf, (nrow(conpoints18_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_18.csv"), row.names = FALSE)
```
...
sample19 <- st_sample(cabuff19_inv_sf, (nrow(conpoints19_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_19.csv"), row.names = FALSE)
...
sample20 <- st_sample(cabuff20_inv_sf, (nrow(conpoints20_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_20.csv"), row.names = FALSE)
...
#sampling random points from the inverse shapefile
sample21 <- st_sample(cabuff21_inv_sf, (nrow(conpoints21_sf) * 5)) %>% 
  st_as_sf()
...
write.csv(clim_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_21.csv"), row.names = FALSE)
...
climdf16 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_16.csv"))

climdf17 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_17.csv"))

climdf18 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_18.csv"))

climdf19 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_19.csv"))

climdf20 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_20.csv"))

climdf21 <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_modeldf_21.csv"))
...
write.csv(climate_model_data_allyears, file = here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_model_data_allyears.csv"), row.names = FALSE)
```
...
```{r}
#read in the data
climate_model_data <- read_csv(here(gdrive_data, "/AnalysisData/robustness_check_data/wir_nonsightings/nonsightings_climate_model_data_allyears.csv"))
```
...
#save the model 
save(climate_model_allyears, file = here("models", "robustness_checks", "filtered_conflict", "nonsightings_climate_model_allyears.rds"))
...
save(mod3climate, file = here("models", "robustness_checks", "filtered_conflict", "nonsightings_mod3climate.rds"))
