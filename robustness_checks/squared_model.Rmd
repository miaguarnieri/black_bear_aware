...
sq_model_climate_all <- rspf(conflict ~ dem + aspect + TRI + popdens + I(popdens^2)+ lc +  I(road_dens^2) + road_dist + streams_dist + urban_dist + rec_dist + forest_dist + forest_dens + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = sq_model_data)
