...
stack16 <- c(dem, aspect, ter_rug, pop16, lc16, road_dens, road_dist, streams_dist, urban_dist_16, rec_dist, fc_dist_16, fdens, dist_fire15, dist_fire13_14, dist_fire11_12)
...
colnames(zero_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs")

colnames(con_vars16) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs")
...
write.csv(modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/modeldf_16.csv"), row.names = FALSE)
...
stack17 <- c(dem, aspect, ter_rug, pop17, lc16, road_dens, road_dist, streams_dist, urban_dist_16,rec_dist,fc_dist_16, fdens, dist_fire16, dist_fire14_15, dist_fire12_13)
...
colnames(zero_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs")

colnames(con_vars17) <- c("conflict", "dem", "aspect", "TRI", "popdens", "lc", "road_dens", "road_dist", "streams_dist", "urban_dist", "rec_dist", "forest_dist", "forest_dens", "dist_fire_1yr", "dist_fire_23yrs", "dist_fire_45yrs")
...
save(basemodel_allyears, file = here(gdrive_data, "/AnalysisData/models/11_1_2022/model_allyears_noclimate/basemodel_allyears.rda"))
