...
write.csv(clim_modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_16.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_17_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_17.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_18_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_18.csv"), row.names = FALSE)
```
...
write.csv(clim_modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_19.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_20_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_20.csv"), row.names = FALSE)
...
write.csv(clim_modeldf_21_year, file = here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_21.csv"), row.names = FALSE)
...
climdf16 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_16.csv"))

climdf17 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_17.csv"))

climdf18 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_18.csv"))

climdf19 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_19.csv"))

climdf20 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_20.csv"))

climdf21 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_climate/11_10_2022/climate_modeldf_21.csv"))
...
clim_mod_no_lc <- rspf(conflict ~ dem + aspect + TRI + popdens + road_dens + road_dist + streams_dist + urban_dist + rec_dist + forest_dist + forest_dens + dist_fire_1yr + dist_fire_23yrs + dist_fire_45yrs + drought, family = "binomial", m = 0, B = 1000, data = climate_model_data)
