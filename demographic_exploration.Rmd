...
nhblack_reporting_mean
nhblack_no_reporting_mean
```
...
amind_combo_reporting_mean
amind_combo_no_reporting_mean
```
...
nhasian_reporting_mean 
nhasian_no_reporting_mean
```
...
nhhipi_reporting_mean
nhhipi_no_reporting_mean
```
...
nhwhite_reporting_mean
nhwhite_no_reporting_mean
...
mean_poverty_reporting
mean_poverty_no_reporting
```
```{r}
