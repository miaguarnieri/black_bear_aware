...
high_conflict <- rast(here(gdrive_data, "/AnalysisData/model_outputs/mod3clim_map_squared.tif"))
...
#hisp_reporting_mean = 3.368873
#hisp_no_reporting_mean = 6.021271
...
#nhblack_reporting_mean = 0.3998586
#nhblack_no_reporting_mean =  0.8407307
```
...
#amind_combo_reporting_mean = 0.4012271
#amind_combo_no_reporting_mean = 0.5081011
```
...
#nhasian_reporting_mean = 1.260077
#nhasian_no_reporting_mean = 2.320014
```
...
#nhhipi_reporting_mean  = 0.02249208
#nhhipi_no_reporting_mean = 0.05605196
...
#nhwhite_reporting_mean = 4.724358 
#nhwhite_no_reporting_mean = 4.624486
...
```{r}
proj_poverty <- project(poverty, ca_total_proj)
proj_mask <- mask(proj_poverty, ca_total_proj)
plot(proj_mask)
```

```{r}
poverty_mask_reporting <- mask(proj_mask, high_conflict_reporting_proj)

poverty_mask_no_reporting <- mask(proj_mask, high_conflict_no_reporting_proj)
```
