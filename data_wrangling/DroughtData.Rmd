...
```{r}
WIR_nonsightings <- WIR_clean %>% 
  filter(confirmed_category %in% c("General Nuisance", "Depredation", "Potential Human Conflict" ))

write.csv(WIR_nonsightings,"WIR_nonsightings.csv", row.names = FALSE)
```
...
=======
>>>>>>> 5e3ececbad33863cfcffc81c3c9dd920b93af680:data_wrangling/DroughtData.Rmd
