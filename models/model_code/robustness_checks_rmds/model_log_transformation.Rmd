...
This Rmd contains the code to create a version of our final base model in which population density and forest distance are log-transformed. 
...
# Run the base model code with log-transformed variables

```{r}

#all-years base model
...
#Set up 5 alternative log-transformed models, with the same covariates as the Hagani et al models
...
save(mod3climate, file = here("models", "robustness_checks", "log_transform", "mod3climate_log.rds"))

save(mod3climate, file = here(gdrive_data, "/AnalysisData/models/1_17_2023/mod3climate_log.rds"))
