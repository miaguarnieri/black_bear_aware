...
Need to add: 2011 - 2015 data

```{r}
#read in fire layers 

ca_fire_2011 <- rast(here(gdrive_data, ""))
...
#Fire distance raster were created in arc gis pro, reading back in here and readjusting extent
