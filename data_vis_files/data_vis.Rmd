...
This Rmd contains the code used to make  data visualizations for this project, including a table of model coefficients, figures displaying transformed coefficients and their confidence intervals, and a marginal effects plot for one specified coefficient.
