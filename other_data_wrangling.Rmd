...
=======
>>>>>>> 016714a0a8b6b012acc00003ccad82419ac30233
...
```{r}
drought_1 <- vect(here(gdrive_data, "/InputData/InputData_Files/Drought/us_drought_monitor/USDM_20221025.shp"))

drought_1_calbers <- project(drought_1, ca_raster)

drought_1_mask <- crop(drought_1_calbers, ca_raster)

drought_1_raster <- rasterize(drought_1_mask, ca_raster)
```
...
writeRaster(x, filename = here(gdrive_data, "/IntermediateData/IntermediateData_Files/drought/us_drought_monitor", name), filetype = "Gtiff", overwrite=TRUE)
}

saverast(drought_1_raster)
```
