...
#create dummy variable for intersecting points

int <- st_intersects(sample_points, con_buff)
  
#select for the ones that are NOT intersecting

zeroes <- st_difference(sample_points, con_buff)
...
road_density <- rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/road_density_arc/2022_10_26_RoadDensity_ClaireERSI.tif"))

#masking the layer to CA
road_density_ca <- mask(road_density, ca_raster)
