...
#4326 is code for WGS 84- map does not render properly otherwise, so we need to reproject later to 6414 (NAD83(2011) / California Albers) (but also I think this issue might go away when I remove the error points that are outside CA)
