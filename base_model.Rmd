...
write.csv(modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_10_2022/modeldf_16.csv"), row.names = FALSE)
...
con_vars19 <- extract(stack19, con_union19, method = "simple", bind = TRUE, ID = TRUE)
...
write.csv(modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_10_2022/modeldf_19.csv"), row.names = FALSE)
