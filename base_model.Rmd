...
write.csv(modeldf_16_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_16.csv"), row.names = FALSE)
...
write.csv(modeldf_17_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_17.csv"), row.names = FALSE)
...
write.csv(modeldf_18_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_18.csv"), row.names = FALSE)
```
...
write.csv(modeldf_19_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_19.csv"), row.names = FALSE)
...
write.csv(modeldf_20_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_20.csv"), row.names = FALSE)
```
...
write.csv(modeldf_21_year, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_21.csv"), row.names = FALSE)
```
...
df16 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_16.csv"))

df17 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_17.csv"))

df18 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_18.csv"))

df19 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_19.csv"))

df20 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_20.csv"))

df21 <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/modeldf_21.csv"))
...
write.csv(model_data_allyears, file = here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/model_data_allyears.csv"), row.names = FALSE)
```
...
```{r}
#read in the data
model_data <- read_csv(here(gdrive_data, "/AnalysisData/model_df_noclimate/11_12_2022/model_data_allyears.csv"))
```
...
save(basemodel_allyears, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/basemodel_allyears.rds"))

#save the model

save(climate_model_allyears, file = here("models", "basemodel_allyears.rds"))
...
```{r}
#mod1
save(mod1, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/mod1.rda"))

#save the model

save(mod1, file = here("models", "mod1.rda"))

#mod2
save(mod2, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/mod2.rda"))

#save the model

save(mod2, file = here("models", "mod2.rda"))

#mod3
save(mod3, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/mod3.rda"))

#save the model

save(mod3, file = here("models", "mod3.rda"))

#mod4

save(mod4, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/mod4.rda"))

#save the model

save(mod4, file = here("models", "mod4.rda"))

#mod5
save(mod5, file = here(gdrive_data, "/AnalysisData/models/11_12_2022/model_allyears_noclimate/mod5.rda"))

#save the model

save(mod5, file = here("models", "mod5.rda"))
