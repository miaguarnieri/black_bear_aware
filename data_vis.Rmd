...
map <- terra::predict(object = stackca_clim_rast, model = climate_model_allyears, fun = predict, factors = f_lc, na.rm = TRUE, type = "response")
...
model<- load(here("models", "robustness checks", "squares", "sq_model_climate_all.rds")) #you have to name the object "model or it will not read in right
