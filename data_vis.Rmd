...
map <- predict(object = stackca_clim_rast, model = climate_model_allyears, fun = predict, factors = f_lc, na.rm = TRUE, type = "response")

#save the map

#writeRaster(map, filename = here(gdrive_data, "/AnalysisData/model_outputs/allyear_clim_map.tif"), filetype = "GTiff", overwrite= TRUE)
...
map_nobinom <- predict(object = stackca_clim_rast, model = climate_model_allyears_nobinom, fun = predict, factors = f)
