...
#any categorical variables used need to be identified first
f <- list(levels(climate_model_data$lc))
names(f) <- "category"
...
```{r}
lc_rast <- terra::rast(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/land_cover/lc19_reclassed.tif"))

lc_rl <- raster(here(gdrive_data, "/IntermediateData/IntermediateData_Files/model_ready/land_cover/lc19_reclassed.tif"), values = TRUE)
```
